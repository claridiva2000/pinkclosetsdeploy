...
const Home = () => {
  ...
  top: '300px'}}>1 Corinthians 14:40</h3>
      ...
      <div className="box2" style={{ height: '50vh' }}>
        ...
        <form style={{ display: 'flex', flexDirection: 'column', justifyContent:'space-between', height:'100px' }}>
